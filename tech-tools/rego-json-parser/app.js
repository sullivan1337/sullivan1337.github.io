...
6. Never return WizMetadata.region or region related info in the rego unless specifically asked
...
async function fetchChatGPT(prompt, apiKey, model, includeConversationHistory = true) {
    ...
    // Parse the response and append assistant's reply to messages
